...
| *config.operations.get* | 아니요 | 예 | 아니요 


| *config.previews.get* | 아니요 | 예 | 아니요 


| *config.previews.list* | 아니요 | 예 | 아니요 


| *config.resources.list* | 아니요 | 예 | 아니요 
...
| *compute.forwardingRules.create* | 백엔드 서비스로의 트래픽 라우팅을 위한 포워딩 규칙을 생성합니다. | 아니요 | 예 | 아니요 
...
| *cloudbuild.builds.get* | 예 | 아니요 | 아니요 
...
| *주소를 계산하고 레이블을 설정합니다* | Address 리소스의 레이블을 업데이트합니다. | 아니요 | 예 | 아니요 
...
| *compute.regionBackendServices.update* | 예 | 예 | 아니요 
