...
| NetApp Backup and Recovery | 5.6.2 (2026년 8월 17일) |  https://docs.netapp.com/us-en/data-services-backup-recovery/whats-new.html["NetApp Backup and Recovery 페이지의 새로운 기능"^]로 이동합니다. 
