...
예를 들어 Microsoft Entra ID를 사용하는 경우 Microsoft 설명서의 단계를 따르면 됩니다link:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["Microsoft Entra ID를 사용하여 도메인 추가"].
