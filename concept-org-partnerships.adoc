...
파트너십을 생성하고 관리하려면 파트너십을 시작하는 조직과 받는 조직 모두에서 한 명 이상의 사용자에게 Partnership admin 역할을 부여해야 합니다. 파트너십을 관리할 필요 없이 보기만 필요한 사용자에게는 Partnership viewer 역할을 부여할 수 있습니다.
