...
---
= Google Cloud에서 NetApp Console 에이전트를 배포합니다
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Google Cloud를 사용하여 Google Cloud에 Console 에이전트를 배포하려면 네트워킹을 설정하고, Google Cloud 권한을 준비하고, Google Cloud API를 활성화한 다음 Console 에이전트를 배포해야 합니다.
