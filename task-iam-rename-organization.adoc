...
---
= NetApp Console 조직의 이름을 변경하고 ID를 가져옵니다
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: 
...
[role="lead"]
NetApp Console 조직에는 이름과 ID가 있습니다. 조직을 식별하는 데 도움이 되도록 이름을 지정할 수 있습니다. 또한 API 호출에 사용할 조직 ID를 알아야 할 수도 있습니다.
...
조직 이름을 변경할 수 있습니다. 여러 조직을 지원하는 경우에 유용합니다.
...
+
image:screenshot-iam-edit-organization.png["작업 아이콘과 조직 편집 옵션이 표시된 조직 페이지의 스크린샷입니다."]
