...
summary: NetApp Console Azure에서 콘솔 에이전트를 시작하면 VM에 사용자 지정 역할을 연결하여 에이전트에 해당 Azure 구독 내의 리소스와 프로세스를 관리할 수 있는 권한을 부여합니다.  에이전트는 이러한 권한을 사용하여 여러 Azure 서비스에 대한 API 호출을 수행합니다. 
---
...
검색 및 복원 기능을 사용하면 에이전트는 다음과 같은 API 요청을 합니다. 인덱싱 v2가 출시되기 전에 레거시 인덱싱 기능을 활성화한 경우에만 이러한 권한이 필요합니다.
...
백업 및 복구에 필요한 최소 권한을 예시에 반영할 수 있도록 JSON 역할 예시에서 다음 권한이 제거되었습니다.

[%collapsible]
====
* Microsoft.Compute/디스크/삭제
* Microsoft.Compute/디스크/읽기
* Microsoft.Compute/디스크/쓰기
* Microsoft.Compute/위치/작업/읽기
* Microsoft.Compute/위치/vmSizes/읽기
* Microsoft.Compute/운영/읽기
* Microsoft.Compute/virtualMachines/instanceView/read
* Microsoft.Compute/virtualMachines/powerOff/action
* Microsoft.Compute/virtualMachines/읽기
* Microsoft.Compute/virtualMachines/다시 시작/작업
* Microsoft.Compute/virtualMachines/할당 해제/작업
* Microsoft.Compute/virtualMachines/시작/작업
* Microsoft.Compute/virtualMachines/vmSizes/읽기
* Microsoft.Compute/virtualMachines/쓰기
* Microsoft.Compute/이미지/읽기
...
* Microsoft.Network/virtualNetworks/checkIpAddressAvailability/읽기
* Microsoft.Network/virtualNetworks/subnets/read
* Microsoft.Network/virtualNetworks/subnets/write
* Microsoft.Network/virtualNetworks/서브넷/virtualMachines/read
...
* Microsoft.Resources/구독/resourceGroups/삭제
* Microsoft.Storage/checknameavailability/read
* Microsoft.Storage/operations/read
* Microsoft.Storage/storageAccounts/삭제
* Microsoft.Storage/사용법/읽기
* Microsoft.Compute/스냅샷/쓰기
* Microsoft.Compute/스냅샷/읽기
* Microsoft.Compute/가용성 세트/쓰기
* Microsoft.Compute/가용성 세트/읽기
* Microsoft.Compute/디스크/beginGetAccess/작업
* Microsoft.Marketplace주문/제안 유형/게시자/제안/계획/계약/읽기
* Microsoft.Marketplace주문/제안 유형/게시자/제안/계획/계약/쓰기
* Microsoft.Network/loadBalancers/읽기
* Microsoft.Network/loadBalancers/쓰기
* Microsoft.Network/loadBalancers/삭제
* Microsoft.Network/loadBalancers/backendAddressPools/read
* Microsoft.Network/loadBalancers/backendAddressPools/join/action
* Microsoft.Network/loadBalancers/loadBalancingRules/read
* Microsoft.Network/loadBalancers/프로브/읽기
...
* Microsoft.Storage/storageAccounts/privateEndpointConnections/읽기
* Microsoft.Network/privateEndpoints/읽기
* Microsoft.Network/privateDnsZones/write
...
* Microsoft.Network/networkSecurityGroups/삭제
* Microsoft.Resources/deployments/delete
* Microsoft.Compute/diskEncryptionSets/읽기
* Microsoft.Compute/스냅샷/삭제
* Microsoft.Network/privateEndpoints/삭제
* Microsoft.Compute/availabilitySets/삭제
* Microsoft.KeyVault/vaults/read
* Microsoft.KeyVault/vaults/accessPolicies/write
* Microsoft.Compute/diskEncryptionSets/쓰기
* Microsoft.KeyVault/vaults/deploy/action
* Microsoft.Compute/diskEncryptionSets/삭제
* Microsoft.Resources/태그/읽기
* Microsoft.Resources/태그/쓰기
* Microsoft.Resources/태그/삭제
* Microsoft.Network/applicationSecurityGroups/write
* Microsoft.Network/applicationSecurityGroups/read
* Microsoft.Network/applicationSecurityGroups/joinIpConfiguration/action
* Microsoft.Network/networkSecurityGroups/securityRules/write
* Microsoft.Network/applicationSecurityGroups/삭제
* Microsoft.Network/networkSecurityGroups/securityRules/삭제
* Microsoft.Synapse/workspaces/write
* Microsoft.Synapse/workspaces/read
* Microsoft.Synapse/workspaces/삭제
* Microsoft.Synapse/등록/작업
