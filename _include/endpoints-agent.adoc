...
|===
a| \https://bluexpinfraprod.eastus2.data.azurecr.io \https://bluexpinfraprod.azurecr.io \https://occmclientinfragov.azurecr.us (제한된 모드 배포에 필요) a| Console 에이전트 업그레이드용 이미지를 얻으려면.

a| https://occmclientinfragov.azurecr.us a| Console 에이전트 업그레이드용 이미지를 얻습니다.
