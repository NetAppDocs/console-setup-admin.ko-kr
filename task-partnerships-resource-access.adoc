...
---
= NetApp Console에서 파트너십 사용자에게 리소스 액세스 권한을 부여합니다.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
파트너 사용자에게 다음과 같은 역할을 할당할 수 있습니다.
...
* link:reference-iam-keystone-roles.html["Keystone 관리자"]
* link:reference-iam-keystone-roles.html["Keystone 뷰어"]
...
. *파트너십*을 선택하세요.
. *파트너십 시작* 탭을 선택하세요.
. 확인하려는 기존 파트너십 옆에 있는 작업 메뉴 image:icon-action.png["세 개의 수직 점이 있는 아이콘"]를 선택하고 *세부 정보 보기*를 선택하세요.
+
