...
* link:reference-iam-predefined-roles.html["데이터 분류 뷰어"]
* link:reference-iam-disaster-rec-roles.html["재해 복구 관리자"]
...
* link:reference-iam-ransomware-roles.html["랜섬웨어 복원력 관리자"]
* link:reference-iam-ransomware-roles.html["랜섬웨어 복원력 뷰어"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["랜섬웨어 복원력 사용자 행동 관리자"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["랜섬웨어 복원력 사용자 동작 뷰어"]
