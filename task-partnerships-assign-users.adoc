...
.필수 역할
파트너십을 생성하고 관리하려면 *Partnership admin* 역할이 필요합니다. *Partnership viewer*는 Partnerships 페이지를 볼 수 있습니다. link:reference-iam-predefined-roles.html["액세스 역할에 대해 자세히 알아보세요."]

언제든지 파트너십에서 사용자를 제거할 수 있습니다. 파트너십에서 사용자를 제거하면 해당 사용자의 파트너 조직 내 모든 리소스에 대한 액세스 권한이 즉시 취소됩니다.
...
파트너십에 구성원을 추가할 때, 파트너 조직의 *Partnership admin*은 구성원이 해당 조직의 특정 리소스에 액세스하기 전에 해당 리소스에 대한 역할을 할당해야 합니다.
...
. *파트너십*을 선택하세요.
. *파트너십 수신* 탭을 선택하세요.
. 멤버를 추가하려는 기존 파트너십 옆에 있는 작업 메뉴 image:icon-action.png["세 개의 수직 점이 있는 아이콘"]를 선택하고 *멤버 추가*를 선택합니다.
. 파트너십에 추가할 구성원을 한 명 이상 선택하고 * 추가 * 를 선택합니다.
...
언제든지 파트너십에서 구성원을 제거할 수 있습니다. 파트너십에서 사용자를 제거하면 해당 사용자의 파트너 조직 내 모든 리소스에 대한 액세스 권한이 즉시 취소됩니다.
...
. *파트너십*을 선택하세요.
. *파트너십 수신* 탭을 선택하세요.
. 삭제하려는 멤버 옆에 있는 작업 메뉴 image:icon-action.png["세 개의 수직 점이 있는 아이콘"]를 선택하고 *연관 삭제*를 선택하세요.
